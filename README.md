...
## ⚠️ 硬體限制（以 DGX Spark 128GB 為基準）

> 本專案以 **128GB DGX Spark** 為首要目標硬體，所有預設配置在此硬體上可運行。

| 硬體 | 記憶體 | 可載入模型 | 同時用戶 |
|------|--------|-----------|---------|
| **DGX Spark** | 128GB | 1x 70B INT4 或 2x 30B | 4-8 人 |
| Mac Studio | 192GB | 1x 122B + 1x 30B | 8-16 人 |
| RTX 5090 | 32GB | 1x 13B INT4 | 1-2 人 |
| H100 | 80GB | 1x 70B | 8-16 人 |

**128GB 實際可用空間**：系統 12GB + 服務 8GB + LLM ~85GB + 緩衝 23GB

**不建議**：同時載入 2x 70B、122B + 完整 RAG、無限制 LRU 自動載入
